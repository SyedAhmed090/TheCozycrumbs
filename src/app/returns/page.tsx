    ...
    <>
      <section className="bg-gradient-to-br from-[#F2E4D5] via-[#EDD8C2] to-[#E4C9AA] py-28 px-20 text-center">
        ...
        <p className="text-lg text-muted max-w-[480px] mx-auto leading-[1.7]">
          Our commitment is your satisfaction. Here&apos;s how we handle issues with your order.
        </p>
      </section>
      ...
      <section className="bg-cream py-24 px-20">
        <div className="max-w-[960px] mx-auto">
            ...
            {[
              {
                ...
                body: "Every item is made fresh and inspected before dispatch. If something doesn't meet our quality standards, we'll make it right.",
              },
              {
                title: '24-Hour Window',
                body: 'All complaints must be raised within 24 hours of receiving your order, along with photographic evidence.',
              },
              {
                title: 'No Physical Returns',
                body: 'As a food business, we cannot accept physical returns. Resolution is via refund, replacement, or store credit.',
              },
            ].map((card) => (
          ...
          <div className="mb-14">
            <h2 className="font-fraunces text-[32px] text-chocolate tracking-[-0.8px] mb-6">
              When We Offer a Refund or Replacement
            </h2>
            <div className="flex flex-col gap-3">
              {REFUND_YES.map((point) => (
                <div
                  key={point}
                  className="flex items-start gap-3 bg-[#4A7C59]/5 border border-[#4A7C59]/15 rounded-xl px-6 py-4"
                >
          ...
          <div className="mb-14">
            ...
            <div className="flex flex-col gap-3">
              {REFUND_NO.map((point) => (
                <div
                  key={point}
                  className="flex items-start gap-3 bg-terracotta/5 border border-terracotta/15 rounded-xl px-6 py-4"
                >
          ...
          <div className="bg-beige rounded-2xl p-10">
            <h2 className="font-fraunces text-[28px] text-chocolate mb-4">How to Raise a Complaint</h2>
            <ol className="flex flex-col gap-4">
              {COMPLAINT_STEPS.map((step, i) => (
                <li key={step} className="flex items-start gap-4">
                  <span className="w-7 h-7 rounded-full bg-caramel/15 text-caramel text-sm font-bold flex items-center justify-center flex-shrink-0">
                    {i + 1}
                  </span>
            ...
            <div className="mt-8 pt-6 border-t border-edge flex items-center gap-4">
              <a
                href="https://wa.me/923350253548"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-terracotta text-white px-6 py-3 rounded-full text-sm font-medium hover:bg-terracotta/90 transition-colors"
              >
                WhatsApp Us
              </a>
              <Link
