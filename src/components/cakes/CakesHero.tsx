...
export default function CakesHero() {
  return (
    <section className="bg-gradient-to-br from-[#F2E4D5] via-[#EDD8C2] to-[#E4C9AA] py-24 px-20 text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h1 className="font-fraunces text-[58px] font-normal text-chocolate tracking-[-1.8px] leading-[1.08] mb-6">
          Every Celebration
          <br />
          Deserves a <em className="italic text-terracotta">Perfect Cake</em>
        </h1>

        <p className="text-lg text-muted max-w-[520px] mx-auto leading-[1.7] mb-10">
