...
const steps = [
  { number: '1', title: 'Browse Treats', description: "Explore our full menu of freshly baked goods and find exactly what you're craving." },
  { number: '2', title: 'Customize Order', description: 'Choose flavors, sizes, and add a personal touch with custom messages or a reference photo.' },
  { number: '3', title: 'Select Delivery', description: 'Pick same day, next day, or schedule ahead. We deliver across Karachi.' },
  { number: '4', title: 'Enjoy Fresh Bakes', description: 'Receive your order packed fresh and beautifully presented, ready to enjoy.' },
]
      ...
      >
        {steps.map((step) => (
          <motion.div key={step.number} variants={itemVariants} className="text-center relative z-10 px-3">
            ...
            <h3 className="font-fraunces text-[17px] lg:text-[19px] font-normal text-ink mb-3">{step.title}</h3>
